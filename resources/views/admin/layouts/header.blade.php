...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/public/assetss/assets/dist/img/user2-160x160.jpg" class="img-circle elevation-2">
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/dashboard') }}" class="nav-link @if(\Illuminate\Support\Facades\Request::segment(2) == 'dashboard') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/admin/list') }}" class="nav-link @if(\Illuminate\Support\Facades\Request::segment(2) == 'admin') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/category/list') }}" class="nav-link @if(\Illuminate\Support\Facades\Request::segment(2) == 'category') active @endif">
